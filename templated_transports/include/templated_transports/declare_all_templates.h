...
#define DECLARE_ALL_TEMPLATES(type) \
PLUGINLIB_EXPORT_CLASS(message_transport::RawPublisher<type>, message_transport::PublisherPlugin<type>)                  \
PLUGINLIB_EXPORT_CLASS(message_transport::RawSubscriber<type>, message_transport::SubscriberPlugin<type>)                \
PLUGINLIB_EXPORT_CLASS(bz2_transport::BZ2Publisher<type>, message_transport::PublisherPlugin<type>)                      \
PLUGINLIB_EXPORT_CLASS(bz2_transport::BZ2Subscriber<type>, message_transport::SubscriberPlugin<type>)                    
